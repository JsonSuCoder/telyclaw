...
tauriApi.im.addDingTalkInstance(name: string)
tauriApi.im.deleteDingTalkInstance(instanceId: string)
tauriApi.im.setDingTalkInstanceConfig(instanceId, config, options?)
// ... 飞书、QQ 同理
```
